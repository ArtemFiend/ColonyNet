"""ColonyNet inference and interpretable anomaly-analysis pipeline.

Detect a Petri dish, segment colonies, extract interpretable features, and
rank objects that deserve review.
"""
...
MODELS_DIR = Path(os.environ.get("COLONYNET_MODELS_DIR", PIPELINE_DIR / "models"))
...
def make_full_pipeline_config(
    output_dir: str | Path = "outputs/colonynet",
